...
namespace AGK
{
	class uString
	{
		...
		public:
			...
			int FindStrCount( const char* str, int ignorecase=0, int start=0 ) const;
			int FindStr( const char* str, int ignorecase=0, int start=0 ) const;
			int RevFindStr( const char* str, int ignorecase=0, int start=-1 ) const;
