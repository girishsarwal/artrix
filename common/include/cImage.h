	...
	*/
	...
	class _EXPORT_ cImage
	{
		...
		protected:
			...
			void SetCachePixelData( unsigned char *pixels, int width, int height, const char* filename );
		...
		public:
			...
			void LoadFromData( int width, int height, unsigned int *bits );
