...
const int VertexColorTexture::OFFSET_TEX0		= 7;
const int VertexColorTexture::SIZE_POSITION		= 3;
const int VertexColorTexture::SIZE_COLOR		= 4;
const int VertexColorTexture::SIZE_TEXT0		= 2;

const int VertexColorTextureNormal::OFFSET_POSITION	= 0;
const int VertexColorTextureNormal::OFFSET_COLOR	= 3;
const int VertexColorTextureNormal::OFFSET_TEX0 	= 7;
const int VertexColorTextureNormal::OFFSET_NORMAL 	= 9;
const int VertexColorTextureNormal::SIZE_POSITION 	= 3;
const int VertexColorTextureNormal::SIZE_COLOR 		= 4;
const int VertexColorTextureNormal::SIZE_TEXT0 		= 2;
